...
#define IIC_DIR P9DIR
#define IIC_OUT P9OUT
#define IIC_IN  P9IN

#define IIC_SCL   BIT2             //SCL定义
#define IIC_SDA   BIT1             //SDA定义

#define SET_SDA   IIC_OUT |= IIC_SDA       //SDA置位
#define SET_SCL   IIC_OUT |= IIC_SCL       //SCL置位
#define CLR_SDA   IIC_OUT &= ~IIC_SDA      //SDA复位
#define CLR_SCL   IIC_OUT &= ~IIC_SCL      //SCL复位
...
//eeprom CAT25128
#define CAT_UNSELECT_CHIP    P2OUT |= BIT0//P3OUT |= BIT6
#define CAT_SELECT_CHIP      P2OUT &= ~BIT0//P3OUT &= ~BIT6

#define CAT_WP               P2OUT &= ~BIT3 //P7OUT &= ~BIT3
#define CAT_NOWP             P2OUT |= BIT3 //P7OUT |= BIT3

#define CAT_BUSY_IN  P3IN
#define CAT_BUSY     BIT2
...
//FLASH sst26
#define UNSELECT_CHIP    P2OUT |= BIT4//P3OUT |= BIT7
#define SELECT_CHIP      P2OUT &= ~BIT4//P3OUT &= ~BIT7

#define AT45DB_WP        P2OUT &= ~BIT2//P7OUT &= ~BIT2
#define AT45DB_NOWP      P2OUT |= BIT2//P7OUT |= BIT2
//==============================================================================
//  函数名称   : UCB2IICInit
//  功能描述   : UCB2IIC总线初始化工作，
//  输入参数   : <无>
...
void UCB2IICInit(void)
{
  ...
  /*
    P9SEL |= 0x06;                // Assign I2C pins to USCI_B0
    ...
    UCB2BR0 = 80;                 // fSCL = ~100kHz
    UCB2BR1 = 0;
    UCB2I2CSA = IIC_SLAVE_ADD;        // Slave Address 
       
    UCB2CTL1 &= ~UCSWRST;             // Clear SW reset, resume operation
    UCB2IE |= UCRXIE + UCTXIE;            // Enable RX interrupt
 */
    P9REN = 0xff;
