...
////////////////短信格式定义定义
#define     INHAND_A01        0x00   //映瀚短信A0-gs格式
#define     INHAND_A0GS       0x01   //映瀚短信A0-1格式
#define     INHAND_A0         0x02   //映瀚通短信A0-1格式（老模块）
#define     HONGDIAN          0x03   //暂定
#define     WANWEI            0x04   //暂定

#define     INHAND_GZ_A01        0x01   //故障短信格式1（映瀚通）      
#define     INHAND_GZ_A0GS       0x02   //故障短信格式2（映瀚通）
#define     INHAND_GZ_A0         0x03   //映瀚通故障短信A0-1格式（老模块）
#define     INHAND_HB_A01        0x04   //短信按字节输出格式（映瀚通），0x55格式的状态汇报用此格式输出
#define     INHAND_HB_A0GS       0x05   //状态汇报短信格式 （映瀚通）
#define     INHAND_HB_A0         0x06
#define     INHAND_DUANXIN       0x07   
#define     INHAND_CHAXUN        0x08
...
#define     ENG_ORDER           0x00
#define     ENG                 0x02   //英文短信
#define     CHN                 0x03   //中文短信
...
#define MAX_FEI_YC_NUM      4   //4种遥测 负荷电流&故障电流 温度 电池电压 电场电压
#define FEI_YC_BYTES        3   //每种遥测占3字节，1字节序号，2字节数据
