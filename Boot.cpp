...
#define WTD_TOG P5OUT ^= BIT4//P7OUT ^= BIT5;// p7.5 看门狗 
...
#define UPSELECT_CHIP      P2OUT &= ~BIT4//P3OUT &= ~BIT7
#define UPUNSELECT_CHIP    P2OUT |= BIT4//P3OUT |= BIT7
...
void UPPortInit(void)@"UPDATECODE"
{
    ...
    //P1DIR = 0x04;
    P1SEL = 0x04;//1.0-GPS秒脉冲输出 1.1-8025固定周期中断1.2-1.4预留 1.51.6-加密芯片相关1.7-GPS控制开关
    P1DIR = 0xE0;
    P1OUT = 0x00;
    P1OUT |= BIT5;
